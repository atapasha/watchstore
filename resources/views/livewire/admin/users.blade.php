             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td class="text-center align-middle" wire:click="changeUserStatus({{$user->id  }})">
                         ...
                         @else
                         <span class="cursor-pointer badge badge-danger">فعال غیر</span>
                     ...
                     <td class="text-center align-middle">{{ $user->created_at ? \Hekmatinasser\Verta\Verta::instance($user->created_at)->formatWord('l dS F') : '-' }}
